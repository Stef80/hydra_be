 ...
 */
@Entity
@Table(name = "tasks", uniqueConstraints = @UniqueConstraint(columnNames = { "project_fk", "task_name", "revision" }))
public class Tasks extends BaseEntity  {
	...
	public Tasks(Projects projects, String taskName, Date dateOfRegistration, Status status, Float totalWorked,
			Date dateOfPublish, Float hoursOfWorking, Integer revision, String tenantId, Set<Assigned> assigneds) {
		this.projects = projects;
		this.taskName = taskName;
		this.dateOfRegistration = dateOfRegistration;
		this.status = status;
